...
BOT_TOKEN = environ.get('BOT_TOKEN', "6733525602:AAHSlqN955nMrcu2Xj31QHJOOL49nTIJloU")
...
STREAM_API = (environ.get('STREAM_API', '890c4813697f994a54ce9b821ef3a35ba0e9eeaf'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002073646130').split()] #Channel id for auto indexing ( make sure bot is admin )
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002179930540') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('RAHUL 0 5G')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://swerahu724855:crazy&xyz@ram.hvospfq.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "RAM")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '890c4813697f994a54ce9b821ef3a35ba0e9eeaf')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))  # else--> True
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/rfggjj')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/rfggjj')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002152575794')) #Log channel id ( make sure bot is admin )
